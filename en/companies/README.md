...
If a contact is identified through a form a company can also be identified/created if:
 ...
 ### Company Scoring
A company's score can be changed through a campaign action or a form action. When one of these actions is selected, first a contact must be identified, and the companies assigned to that contact will have their score changed.
